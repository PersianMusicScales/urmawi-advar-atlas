...
4. Commit with a message such as `Release official PWA edition v4.0.0`.
...
After confirming the live app, create and push tag `v4.0.0`. The release workflow creates a downloadable archive and GitHub release.
